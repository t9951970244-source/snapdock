...
const dict = {
  ru: {
    ...
    recNoSys: 'Звук компьютера недоступен — записывается только картинка',
    recNoMic: 'Микрофон недоступен — пишется только звук компьютера',
  ...
  en: {
    ...
    recNoSys: 'Computer sound is unavailable — only the picture is recorded',
    recNoMic: 'No microphone — recording computer sound only',
